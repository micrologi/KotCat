...
with st.container():
    ...
    with form_container:
        ...
        if enviar:
            ...
            df_empresas = pesquisar_negocios(api_key=API_KEY, negocio=tipo_negocio, latitude=LATITUDE, longitude=LONGITUDE, nota_minima=0, mensagem=mensagem)
                ...
                for index, row in df_pandas.iterrows():
                    ...
                    <div class="empresa-card">
                        ...
                        <div class="empresa-info">
                            <span class="empresa-label">📍</span>
                            <span class="empresa-valor">{row['Endereço']}</span>
                        </div>
                        <div class="empresa-info">
                            <span class="empresa-label">⭐</span>
                            <span class="empresa-valor">
                                <span class="empresa-nota">{row['Nota']:.1f} ({row['Avaliações']} avaliações)</span>
                            </span>
                        </div>
                        <div class="empresa-info">
                            <span class="empresa-label">📞</span>
